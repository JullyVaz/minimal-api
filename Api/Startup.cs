...
<head>
    <meta charset='UTF-8'>
    <title>Bem-vindo à API de Veículos – Minimal API</title>
    <style>
        body {
...
<body>
    <h1>🚗 Bem-vindo a API de Veículos – Minimal API</h1>
    <p>Versão: <strong>v1</strong></p>
    <p><a href='/swagger'>Abrir documentação (Swagger)</a></p>
</body>
</html>";
